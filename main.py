...
def line_detect():
    selected_path = 'C:/Users/svidl/PycharmProjects/FinalProject/' + res
    img = cv2.imread(selected_path)
    print(selected_path)
    ...
    print('dd')
    if lines is None:
        messagebox.showinfo('Error', 'No lines detected')
        return
  ...
  #  cv2.imshow("linesDetected", img)
    data= "Angle:  " + str(angleInDegrees)
    data2 = "Denstitiy: " +str( 1 / real_dist)
    data3 = "Number of frac:" + str(count)
    cv2.putText(img, data, (10,550), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 2)
    cv2.putText(img, data2, (20, 600), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 2)
    cv2.putText(img, data3, (30, 650), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 2)
    cv2.imwrite('images/lines.png', img)
   # ShowInPic(1 / real_dist, count, angleInDegrees)
